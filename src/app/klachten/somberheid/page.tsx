...
export const metadata: Metadata = pageMetadata("/klachten/somberheid", {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "Somberheid",
          item: "https://www.acupunctuurzaandam.nl/klachten/somberheid",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            ...
            {/* Featured Snippet — targets "Helpt acupunctuur bij somberheid?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur ondersteunt bij somberheid en milde depressie door de serotonine- en dopamineaanmaak te stimuleren, het energieniveau te verhogen en slaap te verbeteren. Klinisch onderzoek bevestigt positieve effecten op stemming en vitaliteit — met name wanneer somberheid gepaard gaat met vermoeidheid, stress of slaapproblemen.
              </p>
            </div>
