    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "Lage Rugklachten",
          item: "https://www.acupunctuurzaandam.nl/klachten/lage-rugklachten",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            ...
            {/* Featured Snippet — targets "Helpt acupunctuur bij lage rugklachten?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur verlicht lage rugklachten door endorfines vrij te maken, ontstekingen te remmen en verkrampte spieren te ontspannen. Wetenschappelijk onderzoek (JAMA, Cochrane) bevestigt dat het even effectief is als pijnmedicatie — ook bij spit, hernia en chronische rugpijn — en dat zonder bijwerkingen.
              </p>
            </div>
        ...
        >
          <div className="relative z-20 w-full max-w-6xl mx-auto px-6 text-left">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <BookingWidget id="lage_rugklachten" />
            </div>
          </div>
        </section>
      </main>
