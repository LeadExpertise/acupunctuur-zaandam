...
export const metadata: Metadata = pageMetadata("/klachten/slaapproblemen", {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "Slaapproblemen",
          item: "https://www.acupunctuurzaandam.nl/klachten/slaapproblemen",
        },
      ],
    },
  ],
        ...
        <section id="contact" aria-labelledby="cta-titel" className="overflow-hidden bg-[#1F3A36] pt-32 pb-32 relative">
          <div className="relative z-20 w-full max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <BookingWidget id="slaapproblemen" />
            </div>
          </div>
        </section>
      </main>
