    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Spijsvertering Buik",
          item: "https://www.acupunctuurzaandam.nl/klachten/spijsvertering-buik",
        },
      ],
    },
  ],
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* Featured Snippet — targets "Helpt acupunctuur bij spijsverteringsklachten?" */}
        <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 max-w-3xl mx-auto px-6 mt-8 mb-4">
          ...
          <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
            Ja. Acupunctuur verbetert de spijsvertering door maag- en darmmotiliteit te reguleren, zuurproductie te balanceren en de darm-hersen-as te optimaliseren. Effectief bij een breed scala aan spijsverterings- en buikklachten — van zuurbranden en obstipatie tot buikpijn, PDS en het opgeblazen gevoel.
          </p>
        </div>
        ...
        <section id="contact" aria-labelledby="cta-titel" className="overflow-hidden text-center bg-[#1F3A36] pt-32 pb-32 relative">
          <div className="relative z-20 w-full max-w-6xl mx-auto px-6 text-left">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <BookingWidget id="spijsvertering" />
            </div>
          </div>
        </section>
      </main>
