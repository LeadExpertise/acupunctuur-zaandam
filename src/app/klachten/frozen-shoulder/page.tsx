    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://www.acupunctuurzaandam.nl/klachten/frozen-shoulder",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            {/* Featured Snippet — targets "Helpt acupunctuur bij frozen shoulder?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur is bewezen effectief bij frozen shoulder. Het verlicht pijn door endorfines vrij te maken, vermindert ontstekingen in de gewrichtskapsel en herstelt de doorbloeding. Klinisch onderzoek laat zien dat acupunctuur de beweeglijkheid van de schouder significant verbetert en het herstelproces versnelt.
              </p>
            </div>
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                { href: "/klachten/pijnklachten-en-beweging", label: "Pijn & Beweging" },
              ].map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
        ...
        >
          <div className="relative z-20 w-full max-w-6xl mx-auto px-6 text-left">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <BookingWidget id="frozen_shoulder" />
            </div>
          </div>
        </section>
      </main>
