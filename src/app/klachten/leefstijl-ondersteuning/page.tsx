    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Leefstijl Ondersteuning",
          item: "https://www.acupunctuurzaandam.nl/klachten/leefstijl-ondersteuning",
        },
      ],
    },
  ],
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* Featured Snippet — targets "Helpt acupunctuur bij leefstijlondersteuning?" */}
        <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 max-w-3xl mx-auto mt-10 mb-2 px-6">
          ...
          <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
            Ja. Acupunctuur ondersteunt gezonde leefstijlveranderingen door het zenuwstelsel te reguleren, stresshormonen te verlagen en energieniveaus te verbeteren. Het vermindert trek naar suiker of nicotine, verbetert de slaap, ondersteunt gewichtsbeheersing en verhoogt de algehele vitaliteit — als aanvulling op voedings- en bewegingsprogramma&apos;s.
          </p>
        </div>
        ...
        <section className="py-16 bg-white border-b border-[#1F3A36]/10">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { href: "/klachten/vitaliteit", label: "Vitaliteit" },
                { href: "/klachten/stressklachten", label: "Stressklachten" },
                { href: "/klachten/vermoeidheid", label: "Vermoeidheid" },
                { href: "/klachten/stoppen-met-roken", label: "Stoppen met Roken" },
              ].map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
