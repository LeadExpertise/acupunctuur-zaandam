    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://www.acupunctuurzaandam.nl/klachten/stoppen-met-roken",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            ...
            {/* Featured Snippet — targets "Helpt acupunctuur bij stoppen met roken?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur ondersteunt bij stoppen met roken door de nicotinedrang te verminderen, ontwenningsverschijnselen te verlichten en het zenuwstelsel te kalmeren. Specifieke ooracupunctuurpunten (NADA-protocol) verlagen stress en prikkelbaarheid. Effectief als aanvulling op motivatie en gedragsverandering.
              </p>
            </div>
