    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Trigeminus Neuralgie",
          item: "https://www.acupunctuurzaandam.nl/klachten/trigeminus-neuralgie",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            ...
            {/* Featured Snippet — targets "Helpt acupunctuur bij trigeminusneuralgie?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur verlicht trigeminusneuralgie door de trigeminuszenuw te deactiveren, zenuwontsteking te remmen en pijnpaden centraal te moduleren. Studies tonen aan dat acupunctuur de aanvalsfrequentie en -intensiteit significant vermindert — ook bij patiënten die onvoldoende baat hebben bij medicatie zoals carbamazepine.
              </p>
            </div>
        ...
        <section className="py-16 bg-white border-b border-[#1F3A36]/10">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { href: "/klachten/aangezichtspijn", label: "Aangezichtspijn" },
        ...
        <section id="contact" aria-labelledby="cta-titel" className="overflow-hidden text-center bg-[#1F3A36] pt-32 pb-32 relative">
          <div className="relative z-20 w-full max-w-6xl mx-auto px-6 text-left">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <BookingWidget id="trigeminus_neuralgie" />
            </div>
          </div>
        </section>
      </main>
