    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://www.acupunctuurzaandam.nl/klachten/hormonale-disbalans",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            ...
            {/* Featured Snippet — targets "Helpt acupunctuur bij hormonale disbalans?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur herstelt hormonale balans door de hypothalamus-hypofyse-bijnier-as te reguleren, de productie van oestrogeen, progesteron en cortisol te optimaliseren. Effectief bij PMS, overgangsklachten, PCOS, schildklierproblemen en hormonale vermoeidheid — ook wanneer bloedwaarden &lsquo;normaal&rsquo; zijn maar klachten aanhouden.
              </p>
            </div>
        ...
        <section id="contact" aria-labelledby="cta-titel" className="overflow-hidden text-center bg-[#1F3A36] pt-32 pb-32 relative">
          <div className="relative z-20 w-full max-w-6xl mx-auto px-6 text-left">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <BookingWidget id="hormonale_disbalans" />
            </div>
          </div>
        </section>
      </main>
