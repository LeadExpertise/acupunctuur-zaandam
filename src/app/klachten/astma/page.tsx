    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "Astma",
          item: "https://www.acupunctuurzaandam.nl/klachten/astma",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            ...
            {/* Featured Snippet — targets "Helpt acupunctuur bij astma?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur ondersteunt bij astma door de luchtwegen te ontspannen, de immuunreactie te moduleren en de ademhalingsmusculatuur te versterken. Het vermindert de frequentie en ernst van astma-aanvallen, verlaagt de gevoeligheid voor triggers en verbetert de longfunctie — effectief als aanvulling op reguliere astmamedicatie.
              </p>
            </div>
