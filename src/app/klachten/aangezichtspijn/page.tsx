    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://www.acupunctuurzaandam.nl/klachten/aangezichtspijn",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            ...
            {/* Featured Snippet — targets "Helpt acupunctuur bij aangezichtspijn?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur verlicht aangezichtspijn door de trigeminuszenuw te kalmeren, ontstekingen te remmen en pijnpaden te moduleren. Het is effectief bij trigeminusneuralgie, kaakklachten (TMJ), post-herpetische neuralgie en chronische aangezichtspijn — ook wanneer medicatie onvoldoende werkt of te veel bijwerkingen geeft.
              </p>
            </div>
        ...
        <section className="py-16 bg-white border-b border-[#1F3A36]/10">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { href: "/klachten/trigeminus-neuralgie", label: "Trigeminusneuralgie" },
        ...
        <section id="contact" aria-labelledby="cta-titel" className="overflow-hidden text-center bg-[#1F3A36] pt-32 pb-32 relative">
          <div className="relative z-20 w-full max-w-6xl mx-auto px-6 text-left">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <BookingWidget id="aangezichtspijn" />
            </div>
          </div>
        </section>
      </main>
