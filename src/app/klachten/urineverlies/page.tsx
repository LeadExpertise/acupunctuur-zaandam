    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "Urineverlies",
          item: "https://www.acupunctuurzaandam.nl/klachten/urineverlies",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            ...
            {/* Featured Snippet — targets "Helpt acupunctuur bij urineverlies?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur vermindert urineverlies door de bekkenbodemspieren te versterken, de blaaszenuwregulatie te optimaliseren en urgentie te verminderen. Effectief bij stressincontinentie, urgentie-incontinentie en gemengde incontinentie — bij zowel vrouwen (na bevalling of overgang) als oudere mannen na prostaatproblemen.
              </p>
            </div>
