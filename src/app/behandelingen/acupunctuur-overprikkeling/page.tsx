...
export const metadata: Metadata = pageMetadata("/behandelingen/acupunctuur-overprikkeling", {
  title: "Acupunctuur bij Overprikkeling",
  description:
          ...
          <div className="relative z-20 w-full max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-white/5 rounded-xl overflow-hidden border border-white/10">
                <BookingWidget id="behandeling_overprikkeling" />
              </div>
            </div>
          </div>
        </section>
