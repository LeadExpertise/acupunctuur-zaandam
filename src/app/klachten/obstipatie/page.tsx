...
export const metadata: Metadata = pageMetadata("/klachten/obstipatie", {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "Obstipatie",
          item: "https://www.acupunctuurzaandam.nl/klachten/obstipatie",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            {/* Featured Snippet — targets "Helpt acupunctuur bij obstipatie?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur verlicht obstipatie door de peristaltiek van de dikke darm te stimuleren, de darmzenuwen te activeren en onderliggende spanning te verminderen. Studies tonen aan dat specifieke acupunctuurpunten (zoals ST25 en ST37) de darmmotiliteit effectief versnellen — ook bij chronische, hardnekkige verstopping.
              </p>
            </div>
