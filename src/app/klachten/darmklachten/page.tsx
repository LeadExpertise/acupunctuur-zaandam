...
export const metadata: Metadata = pageMetadata("/klachten/darmklachten", {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "Darmklachten",
          item: "https://www.acupunctuurzaandam.nl/klachten/darmklachten",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            {/* Featured Snippet — targets "Helpt acupunctuur bij darmklachten?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur reguleert de darmmotiliteit, vermindert darmkrampen en herstelt de darm-hersen-as. Het is effectief bij diarree, verstopping, opgeblazen gevoel en chronische darmontsteking — ook bij de functionele darmklachten die niet door bloedonderzoek worden verklaard maar het dagelijks leven sterk belemmeren.
              </p>
            </div>
