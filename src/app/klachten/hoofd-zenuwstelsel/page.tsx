    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Hoofd Zenuwstelsel",
          item: "https://www.acupunctuurzaandam.nl/klachten/hoofd-zenuwstelsel",
        },
      ],
    },
  ],
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* Featured Snippet — targets "Helpt acupunctuur bij hoofd en zenuwstelsel?" */}
        <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 max-w-4xl mx-auto px-6 mt-8 mb-0">
          ...
          <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
            Ja. Acupunctuur ondersteunt het hoofd en zenuwstelsel door de doorbloeding te optimaliseren, het autonome zenuwstelsel te reguleren en overprikkeling te verminderen. Effectief bij hoofdpijn, migraine, duizeligheid, tinnitus en neurologische klachten — met een bewezen rustgevend effect op het centrale zenuwstelsel.
          </p>
        </div>
        ...
        <section id="contact" aria-labelledby="cta-titel" className="overflow-hidden text-center bg-[#1F3A36] pt-32 pb-32 relative">
          <div className="relative z-20 w-full max-w-6xl mx-auto px-6 text-left">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              <BookingWidget id="hoofd_zenuwstelsel" />
            </div>
          </div>
        </section>
      </main>
