    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "Spierpijn",
          item: "https://www.acupunctuurzaandam.nl/klachten/spierpijn",
        },
      ],
    },
  ],
      ...
      <main id="main-content">
        ...
        <article className="py-20 relative z-10 bg-white">
          <div className="max-w-3xl mx-auto px-6 space-y-16">
            {/* Featured Snippet — targets "Helpt acupunctuur bij spierpijn?" */}
            <div className="bg-[#F2EDE3] border-l-4 border-[#4A6559] rounded-r-xl p-6 -mb-4">
              ...
              <p className="text-base text-[#1F3A36]/90 font-light leading-relaxed">
                Ja. Acupunctuur verlicht spierpijn door triggerpoints te deactiveren, spierspanning te verminderen en de aanmaak van endorfines te stimuleren. Onderzoek toont aan dat acupunctuur zowel acuut spierherstel versnelt als chronische spierpijn — zoals bij fibromyalgie of overbelasting — effectief behandelt.
              </p>
            </div>
            <section>
              <h2
